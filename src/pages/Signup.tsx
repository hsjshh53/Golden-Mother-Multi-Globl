    ...
    <div className="min-h-[90vh] flex items-center justify-center p-4">
      ...
      >
        <div className="text-center mb-10">
          ...
          <h1 className="text-4xl font-display font-black uppercase tracking-tighter">New <span className="text-brand-orange">Member</span></h1>
          <p className="text-gray-500 text-[10px] uppercase tracking-[0.2em] mt-3 font-medium">Join the Golden Mother Elite</p>
        </div>
        ...
        <form onSubmit={handleSignup} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="btn-primary w-full py-5 flex items-center justify-center gap-3 mt-4 text-sm uppercase tracking-widest"
          >
        ...
        <p className="text-center text-gray-500 text-sm mt-8">
          Already have an account? <Link to="/login" className="text-brand-orange font-bold hover:underline">Login</Link>
        </p>
      </motion.div>
    </div>
  );
